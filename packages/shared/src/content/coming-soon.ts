...
const en: ComingSoonContent = {
  ...
  subtitle:
    "Shopland connects local sellers with buyers across the country — with cash on delivery, fast shipping, and easy returns.",
  goals: [
  ...
  successMessage: "You're on the list. We'll let you know when Shopland goes live.",
...
const fa: ComingSoonContent = {
  ...
  successMessage: "شما در لیست هستید. وقتی شاپلند فعال شد خبرتان می‌کنیم.",
...
const ps: ComingSoonContent = {
  ...
  successMessage: "تاسو په لیست کې یاست. کله چې شاپلند فعال شي تاسو ته خبر درکوو.",
